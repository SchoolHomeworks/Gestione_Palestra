...
import Presenters.VisualizzaStoricoAbbonamentiPresenter;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;

public class P_VisualizzaStoricoAbbonamenti extends javax.swing.JPanel implements I_VisualizzaStoricoAbbonamentiView{
    private VisualizzaStoricoAbbonamentiPresenter _presenter;
    
    public P_VisualizzaStoricoAbbonamenti() {
        initComponents();
        this._presenter = new VisualizzaStoricoAbbonamentiPresenter(this);
    }
    ...
    private void initComponents() {
        ...
        Tbl_StoricoAbb = new javax.swing.JTable();
        ...
        L_Header.setText("Visualizza Stotico Abbonamenti");
        ...
        Tbl_StoricoAbb.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Abbonamento", "Iniziato il", "Scaduto il"
            }
        ) {
        ...
        jScrollPane2.setViewportView(Tbl_StoricoAbb);
    ...
    private void P_PulVisualizzaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_P_PulVisualizzaMouseClicked
        DefaultTableModel model = (DefaultTableModel) Tbl_StoricoAbb.getModel();
        model.setRowCount(0);
        this._presenter.visualizzaStoricoAbbonamenti(Fld_ID.getText());
    ...
    private javax.swing.JTable Tbl_StoricoAbb;
